...
1 задание) Чтобы собрать образы и запустить службы, выполните следующую команду в терминале:
```shell
docker-compose up --build
```
2 задание) Чтобы собрать образы и запустить службы, выполните следующую команду в терминале:
```shell
task build
```
Запуск:
